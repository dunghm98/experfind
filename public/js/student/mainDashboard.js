...
function accept(request, tutor) {
    $.ajax({
        url: route('student.acceptRequest'),
        type: 'post',
        data: {
            request: request,
            tutor: tutor
...
function CanNotAccept() {
    ...
    let html = `
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Oops!</strong> Hình như bạn đã xác nhận trước đó rùi mà
...
function successAccept() {
    ...
    let html = `
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Yeahh!</strong> Yêu cầu xác nhận gia sư của bạn đã gửi thành công rùi nhaaaa!
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
            </div>
...
function failed() {
    ...
    let html = `
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Oops!</strong> Hic! Có chút vấn đề gì rùi, bạn hãy thử lại sau 1 lát nhé.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
            </div>
