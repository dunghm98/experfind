...
@section('admin-content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <!-- /Page Header -->
            <form action="{{ route('saveSpeciality') }}" method="post">
                @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Tên chuyên môn</h4>
                        </div>
                        <div class="card-body">
                            <input type="hidden" value="{{ $speciality->id }}" name="id">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input value="{{ old('name', $speciality->name) }}" name="name" type="text" class="form-control">
                                        @error('name')
