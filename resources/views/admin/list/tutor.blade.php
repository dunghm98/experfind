                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{route('viewTutor', $tutor->id)}}">{{$tutor->user->name }}</a>
                                            </h2>
                                        </td>

                                        <td class="text-right">
                                            <div class="actions">
                                                <a class="btn btn-sm bg-success-light" href="{{route('viewTutor', $tutor->id)}}">
                                                    <i class="fe fe-pencil"></i> Xem chi tiết
                                                </a>
                                                <a  href="/admin/tutor/delete/{{$tutor->id}}" class="btn btn-sm bg-danger-light">
